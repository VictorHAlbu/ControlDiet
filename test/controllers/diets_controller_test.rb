...
class DietsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diet" do
    assert_difference('Diet.count') do
      post diets_url, params: { diet: { final_date: @diet.final_date, height: @diet.height, ideal_weight: @diet.ideal_weight, start_date: @diet.start_date, weight: @diet.weight } }
    end
  ...
  test "should update diet" do
    patch diet_url(@diet), params: { diet: { final_date: @diet.final_date, height: @diet.height, ideal_weight: @diet.ideal_weight, start_date: @diet.start_date, weight: @diet.weight } }
